    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
                ...
                <dl class="layui-nav-child">
                    <dd><a class="layui-this" href="adminadd.jsp">用户详情</a></dd>
...
<%
				...
				if (name != null & name != null & password != "" & password != null) {
					...
					en_con.close();
                        ...
                        response.sendRedirect("updateresult2.jsp"); 
				}
				}
			%>
...
<%  
    ...
    %> 
<!-- 模态框 -->
  <form method="post" class="form-horizontal" role="form" id="myForm" name="channelform1" onsubmit="return validate_channel_info(this);">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="upwd" name="password" class="form-control well" placeholder="请输入密码"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="upwd" class="col-sm-2 control-label">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话</label>
                                <div class="col-sm-6">
                                    <input type="text" id="upwd" name="tel" class="form-control well" placeholder="请输入电话"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="upwd" class="col-sm-2 control-label">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱</label>
                                <div class="col-sm-6">
                                    <input type="text" id="upwd" name="email" class="form-control well" placeholder="请输入邮箱"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="upwd" class="col-sm-2 control-label">联&nbsp;系&nbsp;人</label>
                                <div class="col-sm-6">
                                    <input type="text" id="upwd" name="family" class="form-control well" placeholder="请输入联系人"/>
                                </div>
                            </div>
                            <div class="form-group">
