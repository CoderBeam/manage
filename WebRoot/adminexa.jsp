...
function confirmDel(id) {  
    if (confirm("亲，您确定删除吗？")){  
        window.location.href="examdelete.jsp?id="+id;
    }
}
</script>
</head>
        ...
        %>
                  <tbody>
                      ...
                      <td class="text-center">
                        ...
                        <button style="margin-left: 10px" class="btn btn-primary" onclick="window.location.href='adminexaupdate.jsp?id=<%=rs.getString(1)%>' ">修改</button>                      
                        </div>
                      </td>
                      </tr>
                                  <%  
