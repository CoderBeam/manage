...
function confirmDel(id) {  
    if (confirm("亲，您确定删除吗？")){  
        window.location.href="examdelete2.jsp?id="+id;
    }
}
</script>
</head>
...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a href="adminexa1.jsp">考核查询</a></dd>
            <dd><a class="layui-this" href="adminexa2.jsp">新增考核</a></dd>  
          </dl>
        </li>
  ...
  <%
				...
				if (name != null & name != null & password != "" & password != null) {
					...
					PreparedStatement en_insert = en_con.prepareStatement("insert into exam(name,password,tel) value(?,?,?)");
					try {
   ...
   <%  
        ...
        if(userid!=null||userid!=""){
        	 sql = "SELECT * FROM exam WHERE uid='" + userid +"' or name='" + userid +"'";
        }if(userid==null||userid==""){
        	 sql = "SELECT * FROM  exam order by uid"; 
        }
                ...
                <div class="layui-form-item" style="text-align:center;">
                  <div class="layui-inline">
                    <div class="layui-input-inline">
                      <input autocomplete="off" class="layui-input" placeholder="请输入编号或考核项" type="text" name="na" value="">
                    </div>
                  </div>
        ...
        %>
                  <tbody>
                      <tr>
                        ...
                        <td style="color: #1ABC9C"><%out.print(rs.getString(4));%></td>
...
<%  
    ...
    %> 
    <!-- 模态框 -->
  <form method="post" name="channelform1" onsubmit="return validate_channel(this);" class="form-horizontal" role="form" id="myForm">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">考&nbsp;核&nbsp;项</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="name" class="form-control well" placeholder="请输入考核项"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="upwd" class="col-sm-2 control-label">考核纪要</label>
                                <div class="col-sm-6">
                                    <input type="text" id="upwd" name="password" class="form-control well" placeholder="请输入考核纪要"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="upwd" class="col-sm-2 control-label">评定标准</label>
                                <div class="col-sm-6">
                                    <input type="text" id="upwd" name="tel" class="form-control well" placeholder="请输入评定标准"/>
                                </div>
                            </div>
                        </form>
                    </div>
