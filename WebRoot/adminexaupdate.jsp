    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a class="layui-this" href="adminexa.jsp">考核总览</a></dd>
...
<form method="post" name="channelform1" onsubmit="return validate_channel(this);" action="adminexaupdate.jsp"> 
              ...
              <table class="layui-table">
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                        	<td>考核项</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="name" class="form-control" placeholder="请输入考核项"/></td>      
                        </tr>
                        <tr>
                        	<td>考核纪要</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="password" class="form-control" placeholder="请输入考核纪要"/></td>               
                        </tr>      
                        <tr>
                        	<td>评定标准</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="tel" class="form-control" placeholder="请输入评定标准"/></td>     
                        </tr>
                        <tr>
...
<%  
        ...
        sql = "update exam set name='"+name+"',password='"+password+"',tel='"+tel+"' where uid ='"+id+"'"; 
