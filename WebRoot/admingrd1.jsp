...
function confirmDel(id) {  
    if (confirm("亲，您确定删除吗？")){  
        window.location.href="grddelete1.jsp?id="+id;
    }
}
</script>
</head>
...
<div class="layui-layout layui-layout-admin">
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	 sql = "SELECT * FROM grdbef WHERE month='" + userid + "' or name='" + userid + "'";
        }if(userid==null||userid==""){
        	 sql = "SELECT * FROM  grdbef order by uid"; 
        }
        ...
        %>
                  ...
                  <tbody>
                      ...
                      <td class="text-center">
                        ...
                        <button style="margin-left: 10px" class="btn btn-primary" onclick="window.location.href='admingrd1update.jsp?id=<%=rs.getString(2)%>' ">修改</button>                      
                        </div>
                      </td>
                      </tr>
                                  <%  
