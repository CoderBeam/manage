      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a class="layui-this" href="admingrd1.jsp">成绩效益</a></dd>
            <dd><a href="admingrd2.jsp">新增成绩</a></dd>  
          </dl>
        </li>
...
<form method="post" name="channelform1" onsubmit="return channe(this);" action="admingrd1update.jsp"> 
              ...
              <table class="layui-table">
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                        	<td>成绩名称</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="email" class="form-control" placeholder="请输入成绩名称"/></td>     
                        </tr>
                        <tr>
                        	<td>成绩效益</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="family" class="form-control" placeholder="请输入成绩效益"/></td>     
                        </tr>
                        <tr>
                        	<td>审核状况</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="sex" class="form-control" placeholder="请输入审核状况"/></td>     
                        </tr>
                        <tr>
...
<%  
        ...
        sql = "update grdbef set name='"+name+"',month='"+password+"',date='"+tel+"',gradesname='"+email+"',bonus='"+family+"',status='"+sex+"' where id ='"+id+"'"; 
