    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a class="layui-this" href="admingrd.jsp">成绩总览</a></dd>
...
<form method="post" name="channelform1" onsubmit="return channel(this);" action="admingrdupdate.jsp"> 
              ...
              <table class="layui-table">
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                        	<td>成绩结果</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="family" class="form-control" placeholder="请输入成绩结果"/></td>     
                        </tr>
                        <tr>
                        	<td>审核状况</td>
...
<%  
        ...
        sql = "update grdall set usern='"+name+"',password='"+password+"',tel='"+tel+"',email='"+email+"',family='"+family+"',sex='"+sex+"' where name ='"+id+"'"; 
