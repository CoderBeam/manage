    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          ...
          <dd><a href="adminmsg.jsp"><strong>修改信息</strong></a></dd>
        </dl>
      </li>
...
<%  
        ...
        //PreparedStatement userinfo=con.prepareStatement(sql);
        ...
        %>
                  ...
                  <tbody>
                      ...
                      <td class="text-center">
                        <div class="layui-btn-group">
                        <button class="btn btn-primary" onclick="window.location.href='adminmsgupdate.jsp?id=<%=rs.getString(1)%>' ">修改</button>             
                  </div>
                      </td>
                      </tr>
                                  <%  
