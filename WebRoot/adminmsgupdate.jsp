...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item"><a class="layui-this" href="adminmsg.jsp">基本信息</a></li>
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a class="layui-this" href="adminmsg.jsp">基本信息</a></dd>
...
<form method="post" name="channelform1" onsubmit="return validate_channel_info(this);" action="adminmsgupdate.jsp"> 
...
<%  
        ...
        sql = "update admin set name='"+name+"',password='"+password+"',tel='"+tel+"',email='"+email+"',family='"+family+"',sex='"+sex+"',major='"+major+"',party='"+party+"' where id ='"+id+"'"; 
