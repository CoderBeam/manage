...
function confirmDel(id) {  
    if (confirm("亲，您确定删除吗？")){  
        window.location.href="saldelete.jsp?id="+id;
    }
}
</script>
</head>
...
<div class="layui-layout layui-layout-admin">
  ...
  <div class="layui-side layui-bg-black">
    ...
    <%
				...
				if (name != null & name != null & password != "" & password != null) {
					...
					PreparedStatement en_insert = en_con.prepareStatement("insert into salall(name,password,tel,email,family,sex) value(?,?,?,?,?,?)");
					try {
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	 sql = "SELECT * FROM salall WHERE month='" + userid +"' or name='" + userid +"'";
        }if(userid==null||userid==""){
        	 sql = "SELECT * FROM  salall order by uid"; 
        }
        ...
        %>
                  ...
                  <tbody>
                      ...
                      <td class="text-center">
                        ...
                        <button style="margin-left: 10px" class="btn btn-primary" onclick="window.location.href='adminsalupdate.jsp?id=<%=rs.getString(2)%>' ">修改</button>                      
                        </div>
                      </td>
                      </tr>
                                  <%  
...
<%  
    ...
    %> 
<!-- 模态框 -->
  <form method="post" name="channelform1" onsubmit="return addinfo(this);" class="form-horizontal" role="form" id="myForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">薪资名称</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="family" class="form-control well" placeholder="请输入薪资名称"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">薪资详细</label>
                                <div class="col-sm-6">
