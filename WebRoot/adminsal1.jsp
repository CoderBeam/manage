...
function confirmDel(id) {  
    if (confirm("亲，您确定删除吗？")){  
        window.location.href="saldelete1.jsp?id="+id;
    }
}
</script>
</head>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            <dd><a href="adminsal.jsp">薪资总览</a></dd>
            <dd><a class="layui-this" href="adminsal1.jsp">扣税信息</a></dd>
  ...
  <%
				...
				if (name != null & name != null & password != "" & password != null) {
					...
					PreparedStatement en_insert = en_con.prepareStatement("insert into salded(id,name,tel,email,family,sex) value(?,?,?,?,?,?)");
					try {
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	 sql = "SELECT * FROM salded WHERE name='" + userid +"' or month='" + userid +"'";
        }if(userid==null||userid==""){
        	 sql = "SELECT * FROM  salded order by uid"; 
        }
        ...
        %>
                  ...
                  <tbody>
                      ...
                      <td class="text-center">
                        ...
                        <button style="margin-left: 10px" class="btn btn-primary" onclick="window.location.href='adminsal1update.jsp?id=<%=rs.getString(2)%>' ">修改</button>                      
                        </div>
                      </td>
                      </tr>
                                  <%  
...
<%  
    ...
    %>
    <!-- 模态框 -->
  <form method="post" name="channelform1" onsubmit="return addetial(this);" class="form-horizontal" role="form" id="myForm">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="name" class="form-control well" placeholder="请输入教职工号"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">用&nbsp;户&nbsp;名</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="password" class="form-control well" placeholder="请输入获奖月份"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">出账月份</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="tel" class="form-control well" placeholder="请输入出账月份"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">详细日期</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="email" class="form-control well" placeholder="请输入详细日期"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">扣税名称</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="family" class="form-control well" placeholder="请输入薪资名称"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="uname" class="col-sm-2 control-label">扣税详细</label>
                                <div class="col-sm-6">
                                    <input type="text" id="uname" name="sex" class="form-control well" placeholder="请输入薪资详细"/>
                                </div>
                            </div>
                        </form>
                    </div>
