...
<form method="post" name="channelform1" onsubmit="return detial(this);" action="adminsal1update.jsp"> 
              ...
              <table class="layui-table">
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                        	<td>用户名</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="user" class="form-control" placeholder="请输入用户名"/></td>               
                        </tr> 
                        <tr>
                        	<td>出账月份</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="month" class="form-control" placeholder="请输入获奖月份"/></td>               
                        </tr>      
                        <tr>
                        	<td>详细日期</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="monthdet" class="form-control" placeholder="请输入详细日期"/></td>     
                        </tr>
                        <tr>
                        	<td>扣税名称</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="disc" class="form-control" placeholder="请输入扣税名称"/></td>     
                        </tr>
                        <tr>
                        	<td>扣税详细</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="discmsg" class="form-control" placeholder="请输入扣税详细"/></td>     
                        </tr>
...
<%  
		...
		String user = gc.GbkChar(request.getParameter("user"));
		String month = gc.GbkChar(request.getParameter("month"));
		String monthdet = gc.GbkChar(request.getParameter("monthdet"));
		String disc = gc.GbkChar(request.getParameter("disc"));
		String discmsg = gc.GbkChar(request.getParameter("discmsg"));
        //驱动程序名   
        ...
        sql = "update salded set name='"+user+"',tel='"+month+"',email='"+monthdet+"',family='"+disc+"',sex='"+discmsg+"' where id ='"+id+"'"; 
