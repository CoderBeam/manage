...
function confirmDel(id) {  
    if (confirm("亲，您确定删除吗？")){  
        window.location.href="saldelete2.jsp?id="+id;
    }
}
</script>
</head>
...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a class="layui-this" href="adminsal2.jsp">实际薪资</a></dd>  
          </dl>
        </li>
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	 sql = "SELECT * FROM salact WHERE name='" + userid +"' or month='" + userid +"'";
        }if(userid==null||userid==""){
        	 sql = "SELECT * FROM  salact"; 
        }
        ...
        %>
                  ...
                  <tbody>
                      ...
                      <td class="text-center">
                        ...
                        <button style="margin-left: 10px" class="btn btn-primary" onclick="window.location.href='adminsal2update.jsp?id=<%=rs.getString(2)%>' ">修改</button>                      
                        </div>
                      </td>
                      </tr>
                                  <%  
