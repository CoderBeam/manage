...
<form method="post" name="channelform1" onsubmit="return detinfo(this);" action="adminsal2update.jsp"> 
              ...
              <table class="layui-table">
                  ...
                  <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                        	<td>出账月份</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="password" class="form-control" placeholder="请输入获奖月份"/></td>               
                        </tr>      
                        <tr>
                        	<td>详细日期</td>
                        ...
                        <tr>
                        	<td>基本薪资</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="email" class="form-control" placeholder="请输入基本薪资"/></td>     
                        </tr>
                        <tr>
                        	<td>扣税薪资</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="family" class="form-control" placeholder="请输入扣税薪资"/></td>     
                        </tr>
                        <tr>
                        	<td>实际薪资</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="sex" class="form-control" placeholder="请输入实际薪资"/></td>     
                        </tr>
                        <tr>
                        	<td>审核状态</td>
                        	<td style="text-align: center"><input style="width: 200px" type="text" id="upwd" name="major" class="form-control" placeholder="请输入审核状态"/></td>     
                        </tr>
                        <tr>
...
<%  
        ...
        sql = "update salact set name='"+name+"',month='"+password+"',date='"+tel+"',salbase='"+email+"',dedmsg='"+family+"',salact='"+sex+"',result='"+major+"' where id ='"+id+"'"; 
