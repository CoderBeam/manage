  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
                ...
                <dl class="layui-nav-child">
                    <dd><a class="layui-this" href="exaAll.jsp">考核总览</a></dd>
    ...
    <%  
        ...
        if(userid!=null||userid!=""){
          	 ...
          	 sql = "SELECT * FROM exaall WHERE id=(SELECT id FROM user WHERE name='"+uname+"') AND month=" + userid;
          	 
          }if(userid==null||userid==""){
        	   
          	 sql = "SELECT * FROM exaall WHERE id=(SELECT id FROM user WHERE name='"+uname+"')" ;
