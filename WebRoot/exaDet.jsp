  ...
  <div class="layui-side layui-bg-black">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
                ...
                <dl class="layui-nav-child">
                    ...
                    <dd><a class="layui-this" href="exaDet.jsp">考核详情</a></dd>
                </dl>
            </li>
      </ul>
    </div>
    ...
    <%  
        ...
        if(userid!=null||userid!=""){
        	...
        	sql = "SELECT * FROM exadet WHERE id=(SELECT id FROM user WHERE name='"+uname+"') AND month=" + userid;
          	
          }if(userid==null||userid==""){
        	  
          	 sql = "SELECT * FROM exadet WHERE id=(SELECT id FROM user WHERE name='"+uname+"')" ;
