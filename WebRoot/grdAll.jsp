...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          <a href="javascript:;">成绩贡献</a>
           <dl class="layui-nav-child">
            <dd><a class="layui-this" href="grdAll.jsp">成绩总览</a></dd>
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	sql = "SELECT * FROM grdall WHERE username=(SELECT name FROM user WHERE name='"+uname+"') AND password=" + userid;
       	 
       }if(userid==null||userid==""){
       	 sql = "SELECT * FROM grdall WHERE username=(SELECT name FROM user WHERE name='"+uname+"')" ;
