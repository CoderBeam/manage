...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a class="layui-this" href="grdBef.jsp">成绩效益</a></dd>
        ...
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd><a href="salAct.html">实际薪资</a></dd>
            </dl>
        </li>
        <li class="layui-nav-item">
  ...
  <%  
		//获取id
		String month = request.getParameter("na");
		//获取用户名
        ...
        if(month!=null||month!=""){
        	sql = "SELECT * FROM grdbef WHERE name=(SELECT name FROM user WHERE name='"+uname+"') AND month=" + month;
          	
          }if(month==null||month==""){
          	 sql = "SELECT * FROM grdbef WHERE name=(SELECT name FROM user WHERE name='"+uname+"')" ;
