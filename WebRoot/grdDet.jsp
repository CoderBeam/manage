...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a class="layui-this" href="grdDet.jsp">成绩详情</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	sql = "SELECT * FROM grddet WHERE id=(SELECT id FROM user WHERE name='"+uname+"') AND month=" + userid;
         	
         }if(userid==null||userid==""){
         	 sql = "SELECT * FROM grddet WHERE id=(SELECT id FROM user WHERE name='"+uname+"')" ;
