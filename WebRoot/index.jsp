    ...
    <div style="padding: 15px;">
      ...
      <!-- 图片 -->
        <div style="margin-top: 20px;margin-left: 150px">
               ...
               <span style="font-family: '仿宋';font-size: 30px;"><strong><a href="admininfo.jsp">用户管理</a></strong></span>
               <img alt="" src="img/kh.png" style="margin-left: 350px">
               <span style="font-family: '仿宋';font-size: 30px"><strong><a href="adminexa.jsp">考核分析</a></strong></span> 
            </div>
            
            <div style="margin-top: 80px;margin-left: 130px">
               <img alt="" src="img/gx.png"> 
               <span style="font-family: '仿宋';font-size: 30px;margin-left: 20px"><strong><a href="admingrd.jsp">成绩贡献</a></strong></span>
               <img alt="" src="img/xz.png" style="margin-left: 340px">
               <span style="font-family: '仿宋';font-size: 30px;margin-left: 10px"><strong><a href="adminsal.jsp">薪资信息</a></strong></span> 
            </div>
