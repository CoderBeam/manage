        ...
        %>
                    <tbody>
                        ...
                        <td><%out.print(rs.getString(9));%></td>
                      	<td class="text-center"><div class="layui-btn-group"><button class="btn btn-primary" onclick="window.location.href='infoCorrupdate.jsp?id=<%=rs.getString(1)%>' ">修改</button></div></td>
                        </tr>     
                    </tbody>  
                </table>
            </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="d1" style="margin-left: 95px">
                        <!--  模态框底部样式，一般是提交或者确定按钮 -->                      
                        <button style="margin-left: 5px" type="submit" class="btn btn-info">提交</button>
