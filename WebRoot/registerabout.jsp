...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item"><a href="registerinfo.jsp">基本信息</a></li>
      <li class="layui-nav-item layui-this"><a href="registerabout.jsp">关于</a></li>
    </ul>
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item">
          ...
          <dl class="layui-nav-child">
            ...
            <dd><a href="registerinfo.jsp">信息修改</a></dd>
            <dd><a href="registerinfo.jsp">更新结果</a></dd>
          </dl>
        </li>
        <li class="layui-nav-item">
