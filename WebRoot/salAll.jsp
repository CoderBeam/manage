  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                <dd><a class="layui-this" href="salAll.jsp">薪资总览</a></dd>
   ...
   <%  
        ...
        if(userid!=null||userid!=""){
        	...
        	sql = "SELECT * FROM salall WHERE name=(SELECT id FROM user WHERE name='"+uname+"') AND tel=" + userid;
         	
         }if(userid==null||userid==""){
       	   
         	 sql = "SELECT * FROM salall WHERE name=(SELECT id FROM user WHERE name='"+uname+"')" ;
