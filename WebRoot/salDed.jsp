...
<div class="layui-layout layui-layout-admin">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                ...
                <dd><a class="layui-this" href="salDed.jsp">扣税信息</a></dd>
  ...
  <%  
        ...
        if(userid!=null||userid!=""){
        	...
        	sql = "SELECT * FROM salded WHERE name=(SELECT name FROM user WHERE name='"+uname+"') AND tel=" + userid;
        	
        }if(userid==null||userid==""){
      	   
        	 sql = "SELECT * FROM salded WHERE name=(SELECT name FROM user WHERE name='"+uname+"')" ;
